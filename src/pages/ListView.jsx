...
const ListView = ({openModal}) => {
 ...
 const [itemOffset, setItemOffset] = useState (10);
  ...
  // gösterilecek son elemanı tespit eder
  const endOffset = itemOffset + itemsPerPage;

  // gösterlecekk elemanları diziden alıyor
...
<tr>
  ...
  <td>{fly.lng}</td>
  <td>
    <button onClick={() => openModal(fly.id)}>Detay</button></td>
